 ...
 */
 ...
 Client.prototype.send = function (options, callback) {
  ...
  if (options.to == 'undefined') {
    throw new Error('you must define to as a propertie');	
  } 
  ...
  if (options.msg == 'undefined' || !_.isString(options.msg)) {
    throw new Error('you must define a proper msg');	
  }
  ...
  req.on('error', function(e) {
    throw new Error('you must define a proper msg' + e);
  });
...
var Response = module.exports.Response = function (response) {
  ...
  if (response.statusCode != 200) {
    throw new Error('Response error from', self._url, 'with code ', response.statusCode);
  }
